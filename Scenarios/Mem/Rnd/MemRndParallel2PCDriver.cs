...
{
    public static class MemRndParallel2PCDriver
    {
        public static void Run()
        {
            ...
            var driver = new TxDriver(
                ...
                (network, clock, random, address, shardLocator, appLocator) => new MemRndParallel2PCAppNode(network, clock, random, address, shardLocator, appLocator, (long)backoffCapUs, attemptsPerIncrease),
            ...
            stat.ExportDuration("read", "memrndpl2pc.read-tx.dist");
            stat.ExportDuration("transfer", "memrndpl2pc.transfer-tx.dist");
            stat.Plot("jeka.memrndpl2pc.png");
        }
