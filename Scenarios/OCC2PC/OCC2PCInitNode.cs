...
{
    public class OCC2PCInitNode : Node, IInitNode
    {
        ...
        public OCC2PCInitNode(IEndpoint network, IClock clock, IRandom random, string address, Func<string, string> shardLocator)
